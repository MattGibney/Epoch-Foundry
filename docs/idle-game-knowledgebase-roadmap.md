...
Knowledgebase and roadmap for building a long-arc idle game with upgrade trees and layered prestige.
...
## 7. MVP Roadmap (Fastest Path)

## 7.1 Phase 0: Foundation (Day 1-2)

- [x] Create project skeleton.
- [x] Implement state model and save/load.
- [x] Implement core tick loop and resource production.
- [ ] Add debug panel for setting resources and fast-forward.

Exit criteria:

- [x] Stable ticking, saving, and restore behavior.

## 7.2 Phase 1: Core Loop (Day 3-5)

- [x] Implement 3 generator tiers with scaling costs.
- [ ] Implement buy 1 / buy 10 / buy max.
- [x] Implement run upgrades.
- [x] Add main production UI.

Exit criteria:

- [ ] Player can progress from Credits to Research with meaningful decisions.

## 7.3 Phase 2: Prestige and Trees (Day 6-8)

- [x] Implement Reboot reset flow and Influence rewards.
- [ ] Implement permanent tree nodes and unlock logic.
- [x] Add prestige panel and tree UI.

Exit criteria:

- [x] Reboot loop functional and clearly accelerates future runs.

## 7.4 Phase 3: Engagement Layer (Day 9-10)

- [ ] Implement contracts (simple randomized objective pool).
- [ ] Implement Overclock burst and cooldown UI.
- [ ] Add basic automation unlocks (autobuy tier 1 first).

Exit criteria:

- [ ] Mid-session decision layer exists beyond raw purchasing.

## 7.5 Phase 4: Stability and Tuning (Day 11-14)

- [ ] Balance pass for first 3-5 Reboots.
- [ ] Add telemetry hooks (local logs are enough for MVP).
- [x] Add migration-aware save versioning.
- [ ] Bug fixing and UX polish.

Exit criteria:

- [ ] Build is stable and enjoyable for repeated multi-day play.

## 8. Implementation Backlog (Prioritized)

Priority legend:

- [ ] `P0`: blocks MVP shipment.
- [ ] `P1`: should ship in MVP.
- [ ] `P2`: post-MVP.

### P0

- [x] Deterministic tick simulation with delta handling.
- [x] Save/load with schema versioning and migration hooks.
- [x] Generator purchase and production formulas.
- [x] Reboot reset and Influence payout.
- [ ] Tree node unlock/purchase logic.
...
- [x] Stats page (run time, total gained, best reboot).
- [ ] Balance config externalization.

### P2

- [ ] Acquisition prestige layer.
- [ ] Timeline Collapse layer.
- [ ] Seasonal modifiers.
- [ ] Build planner/sandbox mode.

## 9. UX and UI Guidelines (MVP)

- [x] Make growth legible: always show current gain/sec per key resource.
- [x] Reduce friction: keep primary actions one click away.
- [x] Surface reset value: show projected Influence before Reboot.
- [x] Always explain blockers: "Need X Components to unlock Labs."
- [x] Prefer panel-based layout with sticky resource header.

## 10. Telemetry Plan (MVP)
...
- [ ] Time to first Reboot.
- [ ] Reboot count per day.
- [ ] Session length distribution.
- [ ] Idle-to-active ratio.
- [ ] Drop-off point by unlock tier.

## 11. Risk Register

- [ ] Number inflation breaks readability.
  - [ ] Mitigation: standardized notation and threshold formatting rules.
- [ ] Prestige feels mandatory too early.
  - [ ] Mitigation: tune first reboot target and boost early non-prestige value.
- [ ] Automation removes strategy.
  - [ ] Mitigation: limit slots and keep priority tradeoffs.
- [ ] Content burnout after week one.
  - [ ] Mitigation: maintain 2-4 upcoming goals visible at all times.

## 12. Post-MVP 12-Month Content Arc

## 12.1 Months 1-2

- [ ] Expand tree depth.
- [ ] Improve contracts and automation complexity.
- [ ] Add challenge runs with modifiers.

## 12.2 Months 3-5

- [ ] Add Acquisition layer and related content.
- [ ] Introduce build-defining keystones.
- [ ] Add meta milestones and milestone rewards.

## 12.3 Months 6-9

- [ ] Add Timeline Collapse and Epoch Shards.
- [ ] Introduce major strategic pivot mechanics.
- [ ] Add long-term mastery objectives.

## 12.4 Months 10-12

- [ ] Add endgame challenge ladders.
- [ ] Add rotating weekly modifiers.
- [ ] Add closure arc (major capstone unlocks).

## 13. Open Questions

- [ ] Should contracts be purely random or curated with weighted progression stages?
- [ ] How much automation should be available before first Reboot?
- [ ] Should Reboot be manual only, or optionally auto-triggered later?
- [ ] What tone should the game carry: minimalist industrial vs lore-heavy sci-fi?

## 14. Next Actions

- [ ] Lock this MVP scope and success criteria.
- [ ] Stand up project scaffold and data tables.
- [x] Implement simulation + save/load first.
- [x] Ship internal prototype targeting first Reboot in under 2 hours.
- [ ] Run a progression pacing pass: tune generator costs, upgrade costs, and prestige gain so early/mid game cadence stays engaging across multi-day play.
- [ ] Move progression content to a data-driven config layer (generators, upgrades, achievements) with validation to make future expansion safer and faster.
- [ ] Add a "next meaningful goal" UX panel on Production (next affordable generator, next unlock, next prestige breakpoint).
- [ ] Add automated tests for economy invariants: tick math, prestige reset behavior, save/load integrity, and unlock requirement enforcement.
